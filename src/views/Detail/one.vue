<template>
  <div class="detail">
    ...
    <img class="flat-map" src="/image/detail/flat-map.png" alt="" />
    <CustomMarker top="55%" left="38.5%" context="Ngoại thị" />
    <CustomMarker top="30%" left="50%" context="Nội thành" />
    <div class="navigation">
      <button class="btn-back" @click="back">Quay lại</button>
      <div class="bar left-bar"></div>
      <div class="main">
        <div class="content">
          <h1 ref="headingText">Thăng Long nội thành ngoại thị</h1>
          <p ref="desText">
