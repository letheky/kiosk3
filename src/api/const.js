...
export const GET_ALL_PERSON_GROUP = "/api/app_person/person-group/"; //It end here no need additional id
export const GET_ALL_PERSON = "/api/app_person/person/";
export const GET_PERSON_BY_ID = "/api/app_person/person/"; 
